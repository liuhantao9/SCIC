...
CONSTRAINT fk_PoliceStations_PositionID
...
IGNORE 1 LINES
(@col1,@col2,@col3,@col4,@col5,@col6,@col7,@col8,@col9,@col10,@col11,@col12,@col13)
set OffenseDescription=@col1, OffenseType=@col2, ReportDate=@col3, OffenseStartDate=@col4, OffenseEndDate=@col13, PositionId=@col12;
