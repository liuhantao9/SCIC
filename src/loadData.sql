...
OffenseType ENUM('VEHICLE THEFT','OTHER PROPERTY','ASSAULT','TRAFFIC','FRAUD','ST
OLEN PROPERTY','WARRANT ARREST','BIKE THEFT','BURGLARY','THREATS','DISTURBANCE','CAR
PROWL','EXTORTION','SHOPLIFTING','PROPERTY DAMAGE','COUNTERFEIT','WEAPON','NARCOTICS
','ROBBERY','BURGLARY-SECURE PARKING-RES','TRESPASS','LOST PROPERTY','DUI','INJURY','
OBSTRUCT','ELUDING','MAIL THEFT','VIOLATION OF COURT ORDER','HOMICIDE','EMBEZZLE','RE
CKLESS BURNING','FORGERY','ANIMAL COMPLAINT','THEFT OF SERVICES','DISPUTE','DISORDERL
Y CONDUCT','PURSE SNATCH','ILLEGAL DUMPING','PROSTITUTION','PICKPOCKET','RECOVERED PR
OPERTY','LIQUOR VIOLATION','FALSE REPORT','LOITERING','HARBOR CALLs','STAY OUT OF ARE
A OF DRUGS','FRAUD AND FINANCIAL','PORNOGRAPHY','[INC - CASE DC USE ONLY]','ESCAPE','
PUBLIC NUISANCE','FIREWORK','BIAS INCIDENT','STAY OUT OF AREA OF PROSTITUTION','GAMBL
E','METRO'),
...
LOAD DATA INFILE '/tmp/SPD_Reports_PositionId_NEWTIME.csv' INTO TABLE Positions
FIELDS TERMINATED BY ',' ENCLOSED BY '"'
LINES TERMINATED BY '\r\n'
IGNORE 1 LINES
(@col1,@col2,@col3,@col4,@col5,@col6,@col7,@col8,@col9,@col10,@col11,@col12,@col13)
set Longitude=@col10,Latitude=@col11;
LOAD DATA INFILE '/tmp/SPD_Reports_PositionId_NEWTIME.csv' INTO TABLE Blocks
FIELDS TERMINATED BY ',' ENCLOSED BY '"'
LINES TERMINATED BY '\r\n'
IGNORE 1 LINES
(@col1,@col2,@col3,@col4,@col5,@col6,@col7,@col8,@col9,@col10,@col11,@col12,@col13)
set Block=@col6;
LOAD DATA INFILE '/tmp/SPD_Reports_PositionId_NEWTIME.csv' INTO TABLE Districts
FIELDS TERMINATED BY ',' ENCLOSED BY '"'
LINES TERMINATED BY '\r\n'
IGNORE 1 LINES
(@col1,@col2,@col3,@col4,@col5,@col6,@col7,@col8,@col9,@col10,@col11,@col12,@col13)
set District=@col7;
LOAD DATA INFILE '/tmp/SPD_Reports_PositionId_NEWTIME.csv' INTO TABLE Beats
FIELDS TERMINATED BY ',' ENCLOSED BY '"'
LINES TERMINATED BY '\r\n'
IGNORE 1 LINES
(@col1,@col2,@col3,@col4,@col5,@col6,@col7,@col8,@col9,@col10,@col11,@col12,@col13)
set Beat=@col8;
LOAD DATA INFILE '/tmp/SPD_Reports_PositionId_NEWTIME.csv' INTO TABLE Censustracts
FIELDS TERMINATED BY ',' ENCLOSED BY '"'
LINES TERMINATED BY '\r\n'
IGNORE 1 LINES
(@col1,@col2,@col3,@col4,@col5,@col6,@col7,@col8,@col9,@col10,@col11,@col12,@col13)
set Censustract=@col9;
LOAD DATA INFILE '/tmp/SPD_Reports_PositionId_NEWTIME.csv' INTO TABLE Offenses
FIELDS TERMINATED BY ',' ENCLOSED BY '"'
LINES TERMINATED BY '\r\n'
IGNORE 1 LINES
(@col1,@col2,@col3,@col4,@col5,@col6,@col7,@col8,@col9,@col10,@col11,@col12,@col13)
set OffenseType=@col2, OffenseDescription=@col1, ReportDate=@col3, OffenseStartDate=@
col4, OffenseEndDate=@col13,PositionId=@col12;
LOAD DATA INFILE '/tmp/SPD_Reports_PositionId_NEWTIME.csv' INTO TABLE TrackedPlace
FIELDS TERMINATED BY ',' ENCLOSED BY '"'
LINES TERMINATED BY '\r\n'
IGNORE 1 LINES
(@col1,@col2,@col3,@col4,@col5,@col6,@col7,@col8,@col9,@col10,@col11,@col12,@col13)
